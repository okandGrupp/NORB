...
def latest_CPE_versions(NORB_path):
...
def parse_args(args: List[str]) -> Dict[str, Any]:
    ...
    parser.add_argument('--NORB_path', type=str, required=True, help="Path of NORB")
...
def main(**args: Dict[str, Any]) -> None:
    NORB_path, save_folder, capec, cwe, cve, cpe, tactic, technique, not_all_cpe_versions = args.values()
