...
def cve_connectivity_by_year(years, search_result_folder, number_or_percent, NORB_folder_path, save_path=None):
    year_to_num_cve_ids = cves_by_year(years, NORB_folder_path)
...
def parse_args(args: List[str]) -> Dict[str, Any]:
    ...
    parser.add_argument('--NORB_folder_path', type=str, required=True, help='Folder path to NORB graph and files')
...
def main(**args: Dict[str, Any]) -> None:
    years, search_result_folder_path, number_or_percent, NORB_folder_path, save_path = args.values()
    years_split = years.split(',')
    cve_connectivity_by_year(years_split, search_result_folder_path, number_or_percent, NORB_folder_path, save_path=save_path)
