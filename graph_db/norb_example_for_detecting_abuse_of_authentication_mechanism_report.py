...
# Query norb with network for report
...
# - NORB display names and metadata
...
def main(ip: str, password: str, username: str, url: str, network_description_file: str="", save_folder: str="", load_folder: str="") -> Dict[str, Any]:
    if load_folder != "":
        ...
        for _file in os.listdir(load_folder):
            if _file.endswith('query_norb.json'):
    ...
    if save_folder != "":
        ...
        for key, value in results.items():
            save_file = os.path.join(save_folder, f"{key}_query_norb.json")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='NORB ArangoDB Example')
    parser.add_argument("--username", type=str, required=True,
                        help="DB username. E.g. guest")
    parser.add_argument("--password", type=str, required=True,
                        help="DB password. E.g. guest")
    parser.add_argument("--ip", type=str, required=True,
                        help="DB IP address. E.g. norb.alfa.csail.mit.edu")
    parser.add_argument("--url", type=str, default='',
                        help="URL to parse and pass through NORB")
    parser.add_argument("--network_description_file", type=str, default='',
                        help="Path to network description. Currently a json with 'nodes' and 'edges'. E.g. graph_db/example_data/network_file_norb.json")
