...
```
python norb_arango.py -f ${PATH_TO_NORB_JSON}
# Expected output
...
- Import into arrango
```
python norb_arango.py --arango_import
# Expected output
Connected to ArangoDB 'http+tcp://127.0.0.1:8529, version: 3.6.9, database: 'NORB', username: 'root'
----------------------------------------
database:               NORB
